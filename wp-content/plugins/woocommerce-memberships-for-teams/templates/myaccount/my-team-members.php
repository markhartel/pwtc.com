...
<div class="woocommerce-account-my-teams">
	...
	<p>
		<?php if ( $seat_count > 0 ) : ?>
			<?php printf( _n( 'This team has <strong>%d seat remaining</strong>.', 'This team has <strong>%d seats remaining</strong>.', $remaining_seats ), $remaining_seats ); ?>
		<?php else : ?>
			<?php _e( 'This team has <strong>unlimited seats</strong>.' ); ?>
		<?php endif; ?>
	</p>
