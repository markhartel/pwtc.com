...
<p><?php /* translators: %1$s - site title, %2$s - a date */ printf( esc_html__( 'Your team membership access at %1$s expired on %2$s!', 'woocommerce-memberships-for-teams' ), $site_title, $membership_end_date ); ?></p>
