...
printf( esc_html__( 'Heads up: your team membership access at %1$s is ending soon! Your membership access will stop on %2$s.', 'woocommerce-memberships-for-teams' ), $site_title, $membership_end_date ) . "\r\n";
