...
if ( ! class_exists( 'Flippercode_Product_Overview' ) ) {
	...
	class Flippercode_Product_Overview {
		...
		function renderMessages() {
			...
			$changelog =  $plugin_updates['changelog'];
			if( $changelog == '' ) {
				$changelog = '<p>What\'s new in the plugin? Click below to get changelog. </p> <button class="fc-btn fc-btn-default fc-communication">View Changelog</button><div class="fcdoc-loader">
			...
			$html = '<div class="fc-divider">
			 <ul class="fc-tabs fc-tabs-list">
			  <li class="active"><a href="#changelog" data-toggle="tab">Changelog</a></li>
			  <li><a href="#plugins" data-toggle="tab">Our Plugins</a></li>
			  <li><a href="javascript:void(0);"><i class="fa fa-refresh fc-communication"></i></a></li>
			 </ul>
			 <div class="fc-tabs-container">
			  <div class="fc-tabs-content active" id="changelog">'.$changelog.'</div>
			  <div class="fc-tabs-content" id="plugins">'.$plugins.'</div>
			</div>
			</div>';
			...
			foreach ( $this->commonBlocks as $block ) {
				...
				switch ( $block ) {
				    case 'product-activation':
						...
						$this->blockHeading = '<h1>Product Information</h1>';

						$this->blockContent .= '
                        <div class="fc-divider fcdoc-brow">
	                       	<div class="fc-2"><i class="fa fa-file-video-o" aria-hidden="true"></i></div>
	                       	<div class="fc-10">For our each product we have set up demo pages where you can see the plugin in working mode.<br><br><strong><a href="'.$this->demoURL.'" target="_blank" class="fc-btn fc-btn-default">Live Demos</a></strong>
	                         </div>
                        </div>';
						...
						$this->blockContent .= '<div class="fc-divider fcdoc-brow">
	                       	...
	                       	<div class="fc-10">Installed version :<br><strong>'.$this->productVersion.'</strong>
							<div class="action">';
						if( $is_update  == true) {
						...
						$this->blockContent .='<br><input type="button" class="fc-btn fc-btn-default check_for_updates_btn" name="check_for_updates_btn" id="check_for_updates_btn" value="Check Updates"><div class="fcdoc-loader updatecheck">
                             <i class="fa fa-circle-o-notch fa-spin fa-3x fa-fw"></i>
							 <span class="sr-only">Loading...</span>
							</div><div class="latest_version_availalbe"></div><span name="plugin_update_status" id="plugin_update_status"></span>';
				    ...
				    case 'newsletter':
				      ...
				      <div class="fc-divider fcdoc-brow"> 
                        ...
                        <div class="fc-divider fcdoc-brow"> 
	                       	...
	                       	<div class="fc-10">We will not share your email addresses in any case.		
	                         </div>
                        </div>';
