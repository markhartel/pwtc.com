...
class RML_Backend {
            ...
            'lang' => array(
                ...
                "toolbarItems" => array(
                    "order" => array(
                        ...
                        "toolTipText" => __('Start to reorder the images in the current gallery. The order of a folder can be reset in the media options.', RML_TD),
    ...
    public function admin_enqueue_scripts($hook) {
    	...
    	/**
    	 * All-in-one jQuery Tree
    	 */
    	wp_enqueue_script('jquery-tooltipster',         plugins_url( 'assets/js/jquery.tooltipster.min.js', RML_FILE ), $requires, RML_VERSION);
    	wp_enqueue_script('jquery-nested-sortable',     plugins_url( 'assets/js/jquery.ui.nested-sortable.js', RML_FILE ), $requires, RML_VERSION);
    	...
    	/**
    	 * Options media relevant scripts
    	 */
    	...
    	/**
    	 * Main RML starter script
    	 */
    	wp_enqueue_script('rml-main',                   plugins_url( 'assets/js/rml.100-main.js', RML_FILE ), $requires, RML_VERSION);
