...
class RML_Core {
    ...
    public function init() {
        ...
        add_action('RML/Item/Move',                             array(RML_Order::getInstance(), 'item_move'), 10, 2);
        add_action('RML/Item/Moved',                            array(RML_Order::getInstance(), 'item_moved_single'), 10, 3);
        add_action('RML/Item/MoveFinished',                     array(RML_Order::getInstance(), 'item_move_finished'), 10, 2);
