...
<?php else : ?>
	...
	<p>
		 ...
		 */
		echo (string) apply_filters( 'wc_memberships_for_teams_my_team_members_no_members_text', __( 'Looks like you your family has no members!', 'woocommerce-memberships-for-teams' ), $team );
