...
<div class="woocommerce-account-my-teams">
	...
	<?php else : ?>
		...
		<p>
			 ...
			 */
			echo (string) apply_filters( 'wc_memberships_for_teams_my_teams_no_teams_text', __( "Looks like you don't have any families yet!", 'woocommerce-memberships-for-teams' ), get_current_user_id() );
