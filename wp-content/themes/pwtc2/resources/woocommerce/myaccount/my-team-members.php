...
<div class="woocommerce-account-my-teams">
	...
	<p>
		<?php if ( $seat_count > 0 ) : ?>
			<?php printf( _n( 'This family has <strong>%d seat remaining</strong>.', 'This family has <strong>%d seats remaining</strong>.', $remaining_seats ), $remaining_seats ); ?>
		<?php else : ?>
			<?php _e( 'This family has <strong>unlimited seats</strong>.' ); ?>
		<?php endif; ?>
	</p>
