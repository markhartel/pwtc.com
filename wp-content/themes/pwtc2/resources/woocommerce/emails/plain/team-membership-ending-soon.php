...
printf( esc_html__( 'Heads up: your family membership access at %1$s is ending soon! Your membership access will stop on %2$s.', 'woocommerce-memberships-for-teams' ), $site_title, $membership_end_date ) . "\r\n";
...
esc_html_e( 'Use the link below to log in and renew your family membership now.', 'woocommerce-memberships-for-teams' ) . "\r\n";
